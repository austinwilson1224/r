...
I picked Site.Name with the value 'Davis-UCD Campus' becaues I live in Davis.
...
> Note that the fires started on 8-15-2020 so I will use data starting on 7-17-2020
...
This graph shows that before the fire the daily mean pm2.5 concentration was relatively low. After August 15 (the day the fires started) the daily mean pm2.5 concentration increased significantly. 
