...
```{r}
before_boolean_mask = data[,"Date"] < as.Date("2020-08-15") & data[,"Date"] > as.Date("2020-07-15")
after_boolean_mask = data[,"Date"] >= as.Date("2020-08-15")
...
# with outliers necessary
bp = boxplot(before$Daily.Mean.PM2.5.Concentration, after$Daily.Mean.PM2.5.Concentration, horizontal = TRUE, names = c("before fire", "after fire"), xlab="pm 2.5 concentration", col = c("blue","orange"))
bp
```
