...
> What questions does it answer? The question this answers is if betting will win in the long term. You can see that the average winnings are trending down. Also we can see that there is a large spread between different gamblers. The lowest having lost $500 and the highest winning about $700. It also answers the question of if 
